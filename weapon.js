...
export class Weapon {
  ...
  // 両手と短い腕。銃と一緒に動くよう、武器と同じrigにぶら下げる。
  createHands(){
    ...
    part(new THREE.BoxGeometry(.12,.13,.14),skin,0,-.11,.05);                                 // 右手
    part(new THREE.BoxGeometry(.13,.13,.26),sleeve,.05,-.23,.23,[.45,0,.12]);                 // 右腕
    part(new THREE.BoxGeometry(.11,.12,.13),skin,0,-.08,-.28);                                // 左手
    part(new THREE.BoxGeometry(.12,.12,.28),sleeve,-.12,-.21,-.14,[.3,0,-.55]);               // 左腕
  }
